...
public class ClasspathFileExtension {
   ...
   * <ul>
   *   <li><b>TRUE</b>: In this case the {@code .classpath} file will be improved if not "opted-out"
   *       by the build-script. In the long run this might be the preferred value for build-srcipt
   *       authors.<br>
   ...
   *       Pro: Full backward compatibility.<br>
   ...
   * 
   * @return true if {@code gradle-modules-plugin} improves {@code .classpath} file,
   *         false otherwise
   */
  ...
  /**
   * Sets the instance attribute controlling whether {@code gradle-modules-plugin} improves
   * {@code .classpath} file or not.
   * 
   * @param improveClasspathFile
   *        new value for instance attribute,<br>
   *        <b>true:</b> {@code gradle-modules-plugin} improves {@code .classpath} file created by
   *        task {@code eclipseClasspath},<br>
   *        <b>false:</b> {code gradle-modules-plugin} doesn't change the {@code .classpath} file
   *        created by task {@code eclipseClasspth}
   *
  public final void setImproveClasspathFile(final boolean improveClasspathFile) {
    insFlagImprove.set(improveClasspathFile);
  } // end method */
} // end class